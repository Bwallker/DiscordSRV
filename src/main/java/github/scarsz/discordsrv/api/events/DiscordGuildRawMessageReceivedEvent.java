...
public class DiscordGuildRawMessageReceivedEvent extends DiscordEvent<GuildMessageReceivedEvent> {
    @Getter
    ...
    public DiscordGuildRawMessageReceivedEvent(GuildMessageReceivedEvent jdaEvent) {
